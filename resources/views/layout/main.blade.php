						...
						<div class="sidebar-wrapper active">
								...
								<div class="sidebar-menu">
										<ul class="menu">
												...
												<li class="sidebar-item" id="postPage">
														<a href="{{ route('post.show')}}" class='sidebar-link'>
																<i class="bi bi-grid-fill"></i>
																<span>Post Management</span>
														</a>
												</li>
												<li class="sidebar-item" id="footballField">
														<a href="{{ route('pitchs.index') }}" class='sidebar-link'>
																<i class="bi bi-grid-fill"></i>
